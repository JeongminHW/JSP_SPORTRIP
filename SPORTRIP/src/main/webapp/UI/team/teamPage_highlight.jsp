...
<div class="highlight-container">
    ...
    $(document).ready(function() {
   	const apiurl = "https://youtube.googleapis.com/youtube/v3/search?part=snippet&"
   		...
   		+ "key=AIzaSyB_a-GhBc7Jp1Sjy63tETxaYDxxrtQ0YoU";
