    ...
    <div class="table-list-box">
        ...
        <div class="table-list">
            <table>
                ...
                <thead>
                    <tr>
                        <th><input type="checkbox" name="numChk" id="checkAll" value="checkAll">번호</th>
                        <th>제목</th>
                        <th>작성자</th>
                        <th>작성일</th>
                        <th>조회</th>
                ...
                <tr>
                    <td><input type="checkbox" name="numChk" class="numChk" value="1">1</td>
                ...
                <tr>
                    <td><input type="checkbox" name="numChk" class="numChk" value="1">2</td>
                ...
                <tr>
                    <td><input type="checkbox" name="numChk" class="numChk" value="1">3</td>
                    <td><a href="">dsfjqlwkefj;lkadjf;lwkefjlwkjflskdjflksjdlfkj</a></td>
                    <td>작성자1</td>
                    <td>2024.09.24</td>
                    <td>1000</td>
                ...
                <tr>
                    <td><input type="checkbox" name="numChk" class="numChk" value="1">4</td>
                    <td><a href="">dsfjqlwkefj;lkadjf;lwkefjlwkjflskdjflksjdlfkj</a></td>
                    <td>작성자1</td>
                    <td>2024.09.24</td>
                    <td>1000</td>
    ...
    <script>
		...
		function sendTeamNum(teamNum, page) {
	 	...
	 	checkAll.addEventListener('click', function(){
	 		...
	 		if(isChecked){
	 			const checkboxes = document.querySelectorAll('.numChk');
	 ...
	 // md 클릭 시 이벤트
	    document.querySelectorAll('.numChk').forEach((item) => {
